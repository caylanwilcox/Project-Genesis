...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-black relative">
      {/* Market Status Bar */}
      <div className="absolute top-0 left-0 right-0 bg-gray-900 border-b border-gray-800 px-4 py-2 z-10">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
              <span className="text-green-400 text-sm font-medium">MARKET {marketStatus.toUpperCase()}</span>
            </div>
          ...
          <div className="flex items-center gap-4 text-sm">
            ...
            <div className="text-gray-400">
              ...
              <span className="text-green-400 ml-2">94.7%</span>
            </div>
            <div className="text-gray-400">
      ...
      {/* Main Grid */}
      <div className="min-h-screen pt-16 md:pt-12 md:grid md:grid-cols-2 md:grid-rows-2 md:gap-0 md:p-0 flex flex-col gap-4 p-4">
        {tickers.map((ticker) => (
          <div
            key={ticker.symbol}
            onClick={() => router.push(`/ticker/${ticker.symbol}`)}
            className={`relative cursor-pointer border border-gray-800 transition-all duration-300 hover:border-gray-600 bg-gray-900 overflow-hidden md:rounded-none md:h-auto rounded-lg h-48 w-full`}
          >
            {/* Animated Background */}
            ...
            <div className="relative h-full flex flex-col justify-between p-6 lg:p-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm mb-4">
                  ...
                  <div>
                    <div className="text-gray-500 text-xs">SELL PRICE</div>
                  ...
                  <div>
                    <div className="text-gray-500 text-xs">TIME IN TRADE</div>
